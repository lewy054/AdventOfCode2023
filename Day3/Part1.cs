...
public partial class Part1 : IResolver
{
    ...
    protected string GetNumberFromSide(int y, int x, SideToSearch sideToSearch)
    {
        var number = "";
        var nextX = x;
        while (true)
    ...
    protected ValidatedList GetNumbersFromTopAndBottom(int y, int x, SideToSearch sideToSearch)
    {
        var nextY = y;
        switch (sideToSearch)
        {
